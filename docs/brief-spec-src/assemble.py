"""브랜드 디자인 규격 약식판 조립 — 템플릿 + 공간 가이드 이미지 재사용 + 표지 썸네일 → docs/브랜드-디자인-규격-약식판-v1.0.{html,pdf}.
...
assemble(S, 'brief-spec.template.html', '브랜드-디자인-규격-약식판-v1.0', images=IMG, post=hex_chips)
