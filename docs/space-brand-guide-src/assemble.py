"""브랜드 가이드 · 공간 조립 — 템플릿 + img/ → docs/브랜드-가이드-공간-v1.1.{html,pdf}. 공용 로직·검사 = docs/assemble_lib.py.
...
assemble(S, 'space-brand-guide.template.html', '브랜드-가이드-공간-v1.1', images=IMG)
