...
- 산출물: `maria-doc-sans-subset.woff2` — 가변 축(wght 45–930) 보존. 문자 = `chars.txt`(KS X 1001 완성형 2350자 + ASCII + Latin-1 보충 + 일반 구두점 + 화살표 + 공간 브랜드 가이드 실사용 문자 + 색상 가이드 상태 기호 ● ⚠ ✓, 2,774자), `unicodes.txt` 는 같은 목록의 코드포인트.
